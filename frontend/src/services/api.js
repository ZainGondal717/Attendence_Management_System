...
// Use environment variable for backend API URL, fallback to deployed backend
const API_BASE_URL = process.env.REACT_APP_API_URL || 'https://attendence-management-system-gcbz.vercel.app/api';
